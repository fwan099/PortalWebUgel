<?php 
 ...
 class ConvocatoriasDirectivosM extends ConexionDB{

    //Crear Convocatorias

 	static public function CrearConvocatoriasDirectivosM($tablaDB,$datosC){
 	...
 	static public function VerConvocatoriasDirectivosM($tablaDB, $item, $valor){
 	...
 	static public function ActualizarConvocatoriasDirectivosM($tablaDB,$datosC){
   ...
   // eliminar comunicados
    ...
    static public function BorrarConvocatoriasDirectivosM($tablaDB,$id){
