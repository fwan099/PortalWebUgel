<?php 
 ...
 class ConvocatoriasDocenteM extends ConexionDB{
    ...
    //Crear Convocatorias
 	...
 	static public function CrearConvocatoriasDocenteM($tablaDB,$datosC){
 	...
 	static public function VerConvocatoriasDocenteM($tablaDB, $item, $valor){
 	...
 	static public function ActualizarConvocatoriasDocenteM($tablaDB,$datosC){
   ...
   // eliminar comunicados
    ...
    static public function BorrarConvocatoriasDocenteM($tablaDB,$id){
