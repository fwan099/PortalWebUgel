<?php 
 ...
 class ConvocatoriasAuxiliarM extends ConexionDB{
    ...
    //Crear Convocatorias
 	...
 	static public function CrearConvocatoriasAuxiliarM($tablaDB,$datosC){
 	...
 	static public function VerConvocatoriasAuxiliarM($tablaDB, $item, $valor){
 	...
 	static public function ActualizarConvocatoriasAuxiliarM($tablaDB,$datosC){
   ...
   // eliminar comunicados
    ...
    static public function BorrarConvocatoriasAuxiliarM($tablaDB,$id){
