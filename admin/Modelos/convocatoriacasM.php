<?php 
 ...
 class ConvocatoriasCasM extends ConexionDB{
    ...
    //Crear Convocatorias
 	...
 	static public function CrearConvocatoriasCasM($tablaDB,$datosC){
 	...
 	static public function VerConvocatoriasCasM($tablaDB, $item, $valor){
 	...
 	static public function ActualizarConvocatoriasCasM($tablaDB,$datosC){
   ...
   // eliminar comunicados
    ...
    static public function BorrarConvocatoriasCasM($tablaDB,$id){
