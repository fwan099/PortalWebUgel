...
class DireccionM extends ConexionDB{
	...
	static public function VerDireccionM($tablaDB){
	...
	static public function EditarDireccionM($tablaDB,$id){
	...
	static public function ActualizarDireccionM($tablaDB,$datosC){
