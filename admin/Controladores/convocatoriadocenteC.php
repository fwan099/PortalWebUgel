<?php 
 ...
 class ConvocatoriasDocenteC{
 	...
 	public function CrearConvocatoriasDocenteC(){
 		...
 		if(isset($_POST["fechaN"])){
 			...
 			if(isset($_FILES["documentoN1"]["tmp_name"]) && !empty($_FILES["documentoN1"]["tmp_name"])){
 				...
 				if($_FILES["documentoN1"]["type"] == "application/pdf"){
 					...
 					$rutaPdf1 = "Vistas/files/convocatoriasdocente/C".$nombre.".pdf";
 			...
 			if(isset($_FILES["documentoN2"]["tmp_name"]) && !empty($_FILES["documentoN2"]["tmp_name"])){
 				...
 				if($_FILES["documentoN2"]["type"] == "application/pdf"){
 					...
 					$nombre = mt_rand(10,999);
 					$rutaPdf2 = "Vistas/files/convocatoriasdocente/C".$nombre.".pdf";
 			...
 			if(isset($_FILES["documentoN3"]["tmp_name"]) && !empty($_FILES["documentoN3"]["tmp_name"])){
 				...
 				if($_FILES["documentoN3"]["type"] == "application/pdf"){
 					...
 					$nombre = mt_rand(10,999);
 					$rutaPdf3 = "Vistas/files/convocatoriasdocente/C".$nombre.".pdf";
 			...
 			if(isset($_FILES["documentoN4"]["tmp_name"]) && !empty($_FILES["documentoN4"]["tmp_name"])){
 				...
 				if($_FILES["documentoN4"]["type"] == "application/pdf"){
 					...
 					$nombre = mt_rand(10,999);
 					$rutaPdf4 = "Vistas/files/convocatoriasdocente/C".$nombre.".pdf";
 			...
 			if(isset($_FILES["documentoN5"]["tmp_name"]) && !empty($_FILES["documentoN5"]["tmp_name"])){
 				...
 				if($_FILES["documentoN5"]["type"] == "application/pdf"){
 					...
 					$nombre = mt_rand(10,999);
 					$rutaPdf5 = "Vistas/files/convocatoriasdocente/C".$nombre.".pdf";
 			...
 			if(isset($_FILES["documentoN6"]["tmp_name"]) && !empty($_FILES["documentoN6"]["tmp_name"])){
 				...
 				if($_FILES["documentoN6"]["type"] == "application/pdf"){
 					...
 					$nombre = mt_rand(10,999);
 					$rutaPdf6 = "Vistas/files/convocatoriasdocente/C".$nombre.".pdf";
 			...
 			$respuesta = ConvocatoriasDocenteM::CrearConvocatoriasDocenteM($tablaDB,$datosC);

 			if($respuesta == true){

				echo ' <script>

					window.location = "convocatoriasDocente";
 	...
 	static public function VerConvocatoriasDocenteC($item, $valor){

 		$tablaDB = "convocatoria_docente";
 		$respuesta = ConvocatoriasDocenteM::VerConvocatoriasDocenteM($tablaDB, $item, $valor);
 		return $respuesta;
 	}

 	// actulizar convocatorias cas

 	public function ActualizarConvocatoriasDocenteC(){
	 		...
	 		$respuesta = ConvocatoriasDocenteM::ActualizarConvocatoriasDocenteM($tablaDB,$datosC);
 ...
 // eliminar convocatoria
 	...
 	public function BorrarConvocatoriasDocenteC(){
 		...
 		if(isset($_GET["Cid"])){
			...
			$respuesta = ConvocatoriasDocenteM::BorrarConvocatoriasDocenteM($tablaDB,$id);
