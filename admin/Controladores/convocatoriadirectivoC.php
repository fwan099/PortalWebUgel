<?php 
 ...
 class ConvocatoriasDirectivosC{

 	//crear convocatorias cas 
 	public function CrearConvocatoriasDirectivosC(){
 		...
 		if(isset($_POST["fechaN"])){
 			...
 			if(isset($_FILES["documentoN1"]["tmp_name"]) && !empty($_FILES["documentoN1"]["tmp_name"])){
 				...
 				if($_FILES["documentoN1"]["type"] == "application/pdf"){
 					...
 					$rutaPdf1 = "Vistas/files/convocatoriasdirectivo/C".$nombre.".pdf";
 			...
 			if(isset($_FILES["documentoN2"]["tmp_name"]) && !empty($_FILES["documentoN2"]["tmp_name"])){
 				...
 				if($_FILES["documentoN2"]["type"] == "application/pdf"){
 					...
 					$nombre = mt_rand(10,999);
 					$rutaPdf2 = "Vistas/files/convocatoriasdirectivo/C".$nombre.".pdf";
 			...
 			if(isset($_FILES["documentoN3"]["tmp_name"]) && !empty($_FILES["documentoN3"]["tmp_name"])){
 				...
 				if($_FILES["documentoN3"]["type"] == "application/pdf"){
 					...
 					$nombre = mt_rand(10,999);
 					$rutaPdf3 = "Vistas/files/convocatoriasdirectivo/C".$nombre.".pdf";
 			...
 			if(isset($_FILES["documentoN4"]["tmp_name"]) && !empty($_FILES["documentoN4"]["tmp_name"])){
 				...
 				if($_FILES["documentoN4"]["type"] == "application/pdf"){
 					...
 					$nombre = mt_rand(10,999);
 					$rutaPdf4 = "Vistas/files/convocatoriasdirectivo/C".$nombre.".pdf";
 			...
 			if(isset($_FILES["documentoN5"]["tmp_name"]) && !empty($_FILES["documentoN5"]["tmp_name"])){
 				...
 				if($_FILES["documentoN5"]["type"] == "application/pdf"){
 					...
 					$nombre = mt_rand(10,999);
 					$rutaPdf5 = "Vistas/files/convocatoriasdirectivo/C".$nombre.".pdf";
 			...
 			if(isset($_FILES["documentoN6"]["tmp_name"]) && !empty($_FILES["documentoN6"]["tmp_name"])){
 				...
 				if($_FILES["documentoN6"]["type"] == "application/pdf"){
 					...
 					$nombre = mt_rand(10,999);
 					$rutaPdf6 = "Vistas/files/convocatoriasdirectivo/C".$nombre.".pdf";
 			...
 			$tablaDB = "convocatoria_directivo";
 			...
 			$respuesta = ConvocatoriasDirectivosM::CrearConvocatoriasDirectivosM($tablaDB,$datosC);

 			if($respuesta == true){

				echo ' <script>

					window.location = "convocatoriasDirectivo";
 	...
 	static public function VerConvocatoriasDirectivosC($item, $valor){

 		$tablaDB = "convocatoria_directivo";
 		$respuesta = ConvocatoriasDirectivosM::VerConvocatoriasDirectivosM($tablaDB, $item, $valor);
 		return $respuesta;
 	}

 	// actulizar convocatorias cas

 	public function ActualizarConvocatoriasDirectivosC(){
	 		...
	 		$respuesta = ConvocatoriasDirectivosM::ActualizarConvocatoriasDirectivosM($tablaDB,$datosC);
 ...
 // eliminar convocatoria
 	...
 	public function BorrarConvocatoriasDirectivosC(){
 		...
 		if(isset($_GET["Cid"])){
			...
			$respuesta = ConvocatoriasDirectivosM::BorrarConvocatoriasDirectivosM($tablaDB,$id);
