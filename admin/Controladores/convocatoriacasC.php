<?php 
 ...
 class ConvocatoriasCasC{

 	//crear convocatorias cas 
 	public function CrearConvocatoriasCasC(){
 		...
 		if(isset($_POST["fechaN"])){
 			...
 			if(isset($_FILES["documentoN1"]["tmp_name"]) && !empty($_FILES["documentoN1"]["tmp_name"])){
 				...
 				if($_FILES["documentoN1"]["type"] == "application/pdf"){
 					...
 					$rutaPdf1 = "Vistas/files/convocatoriascas/C".$nombre.".pdf";
 			...
 			if(isset($_FILES["documentoN2"]["tmp_name"]) && !empty($_FILES["documentoN2"]["tmp_name"])){
 				...
 				if($_FILES["documentoN2"]["type"] == "application/pdf"){
 					...
 					$nombre = mt_rand(10,999);
 					$rutaPdf2 = "Vistas/files/convocatoriascas/C".$nombre.".pdf";
 			...
 			if(isset($_FILES["documentoN3"]["tmp_name"]) && !empty($_FILES["documentoN3"]["tmp_name"])){
 				...
 				if($_FILES["documentoN3"]["type"] == "application/pdf"){
 					...
 					$nombre = mt_rand(10,999);
 					$rutaPdf3 = "Vistas/files/convocatoriascas/C".$nombre.".pdf";
 			...
 			if(isset($_FILES["documentoN4"]["tmp_name"]) && !empty($_FILES["documentoN4"]["tmp_name"])){
 				...
 				if($_FILES["documentoN4"]["type"] == "application/pdf"){
 					...
 					$nombre = mt_rand(10,999);
 					$rutaPdf4 = "Vistas/files/convocatoriascas/C".$nombre.".pdf";
 			...
 			if(isset($_FILES["documentoN5"]["tmp_name"]) && !empty($_FILES["documentoN5"]["tmp_name"])){
 				...
 				if($_FILES["documentoN5"]["type"] == "application/pdf"){
 					...
 					$nombre = mt_rand(10,999);
 					$rutaPdf5 = "Vistas/files/convocatoriascas/C".$nombre.".pdf";
 			...
 			if(isset($_FILES["documentoN6"]["tmp_name"]) && !empty($_FILES["documentoN6"]["tmp_name"])){
 				...
 				if($_FILES["documentoN6"]["type"] == "application/pdf"){
 					...
 					$nombre = mt_rand(10,999);
 					$rutaPdf6 = "Vistas/files/convocatoriascas/C".$nombre.".pdf";
 			...
 			$respuesta = ConvocatoriasCasM::CrearConvocatoriasCasM($tablaDB,$datosC);

 			if($respuesta == true){

				echo ' <script>

					window.location = "convocatoriascas";
 	...
 	static public function VerConvocatoriasCasC($item, $valor){

 		$tablaDB = "convocatoria_cas";
 		$respuesta = ConvocatoriasCasM::VerConvocatoriasCasM($tablaDB, $item, $valor);
 		return $respuesta;
 	}

 	// actulizar convocatorias cas

 	public function ActualizarConvocatoriasCasC(){
	 		...
	 		$respuesta = ConvocatoriasCasM::ActualizarConvocatoriasCasM($tablaDB,$datosC);
 ...
 // eliminar convocatoria
 	...
 	public function BorrarConvocatoriasCasC(){
 		...
 		if(isset($_GET["Cid"])){
			...
			$respuesta = ConvocatoriasCasM::BorrarConvocatoriasCasM($tablaDB,$id);
