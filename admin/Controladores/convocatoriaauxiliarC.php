<?php 
 ...
 class ConvocatoriasAuxiliarC{

 	//crear convocatorias cas 
 	public function CrearConvocatoriasAuxiliarC(){
 		...
 		if(isset($_POST["fechaN"])){
 			...
 			if(isset($_FILES["documentoN1"]["tmp_name"]) && !empty($_FILES["documentoN1"]["tmp_name"])){
 				...
 				if($_FILES["documentoN1"]["type"] == "application/pdf"){
 					...
 					$rutaPdf1 = "Vistas/files/convocatoriasauxiliar/C".$nombre.".pdf";
 			...
 			if(isset($_FILES["documentoN2"]["tmp_name"]) && !empty($_FILES["documentoN2"]["tmp_name"])){
 				...
 				if($_FILES["documentoN2"]["type"] == "application/pdf"){
 					...
 					$nombre = mt_rand(10,999);
 					$rutaPdf2 = "Vistas/files/convocatoriasauxiliar/C".$nombre.".pdf";
 			...
 			if(isset($_FILES["documentoN3"]["tmp_name"]) && !empty($_FILES["documentoN3"]["tmp_name"])){
 				...
 				if($_FILES["documentoN3"]["type"] == "application/pdf"){
 					...
 					$nombre = mt_rand(10,999);
 					$rutaPdf3 = "Vistas/files/convocatoriasauxiliar/C".$nombre.".pdf";
 			...
 			if(isset($_FILES["documentoN4"]["tmp_name"]) && !empty($_FILES["documentoN4"]["tmp_name"])){
 				...
 				if($_FILES["documentoN4"]["type"] == "application/pdf"){
 					...
 					$nombre = mt_rand(10,999);
 					$rutaPdf4 = "Vistas/files/convocatoriasauxiliar/C".$nombre.".pdf";
 			...
 			if(isset($_FILES["documentoN5"]["tmp_name"]) && !empty($_FILES["documentoN5"]["tmp_name"])){
 				...
 				if($_FILES["documentoN5"]["type"] == "application/pdf"){
 					...
 					$nombre = mt_rand(10,999);
 					$rutaPdf5 = "Vistas/files/convocatoriasauxiliar/C".$nombre.".pdf";
 			...
 			if(isset($_FILES["documentoN6"]["tmp_name"]) && !empty($_FILES["documentoN6"]["tmp_name"])){
 				...
 				if($_FILES["documentoN6"]["type"] == "application/pdf"){
 					...
 					$nombre = mt_rand(10,999);
 					$rutaPdf6 = "Vistas/files/convocatoriasauxiliar/C".$nombre.".pdf";
 			...
 			$respuesta = ConvocatoriasAuxiliarM::CrearConvocatoriasAuxiliarM($tablaDB,$datosC);

 			if($respuesta == true){

				echo ' <script>

					window.location = "convocatoriasAuxiliar";
 	...
 	static public function VerConvocatoriasAuxiliarC($item, $valor){

 		$tablaDB = "convocatoria_auxiliar";
 		$respuesta = ConvocatoriasAuxiliarM::VerConvocatoriasAuxiliarM($tablaDB, $item, $valor);
 		return $respuesta;
 	}

 	// actulizar convocatorias cas

 	public function ActualizarConvocatoriasAuxiliarC(){
	 		...
	 		$respuesta = ConvocatoriasAuxiliarM::ActualizarConvocatoriasAuxiliarM($tablaDB,$datosC);
 ...
 // eliminar convocatoria
 	...
 	public function BorrarConvocatoriasAuxiliarC(){
 		...
 		if(isset($_GET["Cid"])){
			...
			$respuesta = ConvocatoriasAuxiliarM::BorrarConvocatoriasAuxiliarM($tablaDB,$id);
