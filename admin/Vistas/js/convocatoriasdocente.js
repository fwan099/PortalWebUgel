...
$(".TB").on("click",".EditarConvocatoriaD" , function(){
	...
	$.ajax({
		url :"Ajax/convocatoriasdocenteA.php",
		method:"POST",
		data: datos,
		cache: false,
		contentType: false,
...
$(".TB").on("click",".BorrarConvocatoriaD" , function(){
	...
	window.location = "index.php?url=convocatoriasDocente&Cid="+Cid+"&documentoConvocatorias1="+documentoConvocatorias1;
	window.location = "index.php?url=convocatoriasDocente&Cid="+Cid+"&documentoConvocatorias2="+documentoConvocatorias2;
	window.location = "index.php?url=convocatoriasDocente&Cid="+Cid+"&documentoConvocatorias3="+documentoConvocatorias3;
	window.location = "index.php?url=convocatoriasDocente&Cid="+Cid+"&documentoConvocatorias4="+documentoConvocatorias4;
	window.location = "index.php?url=convocatoriasDocente&Cid="+Cid+"&documentoConvocatorias5="+documentoConvocatorias5;
	window.location = "index.php?url=convocatoriasDocente&Cid="+Cid+"&documentoConvocatorias6="+documentoConvocatorias6;
	window.location = "index.php?url=convocatoriasDocente&Cid="+Cid+"&documentoConvocatorias7="+documentoConvocatorias7;
