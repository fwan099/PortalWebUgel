...
$(".TB").on("click",".EditarConvocatoriaDI" , function(){
	...
	$.ajax({
		url :"Ajax/convocatoriasdirectivoA.php",
		method:"POST",
		data: datos,
		cache: false,
		contentType: false,
...
$(".TB").on("click",".BorrarConvocatoriaDI" , function(){
	...
	window.location = "index.php?url=convocatoriasDirectivo&Cid="+Cid+"&documentoConvocatorias1="+documentoConvocatorias1;
	window.location = "index.php?url=convocatoriasDirectivo&Cid="+Cid+"&documentoConvocatorias2="+documentoConvocatorias2;
	window.location = "index.php?url=convocatoriasDirectivo&Cid="+Cid+"&documentoConvocatorias3="+documentoConvocatorias3;
	window.location = "index.php?url=convocatoriasDirectivo&Cid="+Cid+"&documentoConvocatorias4="+documentoConvocatorias4;
	window.location = "index.php?url=convocatoriasDirectivo&Cid="+Cid+"&documentoConvocatorias5="+documentoConvocatorias5;
	window.location = "index.php?url=convocatoriasDirectivo&Cid="+Cid+"&documentoConvocatorias6="+documentoConvocatorias6;
	window.location = "index.php?url=convocatoriasDirectivo&Cid="+Cid+"&documentoConvocatorias7="+documentoConvocatorias7;
