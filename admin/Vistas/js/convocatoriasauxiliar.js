...
$(".TB").on("click",".EditarConvocatoriaA" , function(){
	...
	$.ajax({
		url :"Ajax/convocatoriasauxiliarA.php",
		method:"POST",
		data: datos,
		cache: false,
		contentType: false,
...
$(".TB").on("click",".BorrarConvocatoriaA" , function(){
	...
	window.location = "index.php?url=convocatoriasAuxiliar&Cid="+Cid+"&documentoConvocatorias1="+documentoConvocatorias1;
	window.location = "index.php?url=convocatoriasAuxiliar&Cid="+Cid+"&documentoConvocatorias2="+documentoConvocatorias2;
	window.location = "index.php?url=convocatoriasAuxiliar&Cid="+Cid+"&documentoConvocatorias3="+documentoConvocatorias3;
	window.location = "index.php?url=convocatoriasAuxiliar&Cid="+Cid+"&documentoConvocatorias4="+documentoConvocatorias4;
	window.location = "index.php?url=convocatoriasAuxiliar&Cid="+Cid+"&documentoConvocatorias5="+documentoConvocatorias5;
	window.location = "index.php?url=convocatoriasAuxiliar&Cid="+Cid+"&documentoConvocatorias6="+documentoConvocatorias6;
	window.location = "index.php?url=convocatoriasAuxiliar&Cid="+Cid+"&documentoConvocatorias7="+documentoConvocatorias7;
