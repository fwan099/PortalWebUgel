...
$(".TB").on("click",".EditarConvocatoriaCAP" , function(){
	...
	$.ajax({
		url :"Ajax/convocatoriascapA.php",
		method:"POST",
		data: datos,
		cache: false,
		contentType: false,
...
$(".TB").on("click",".BorrarConvocatoriaCAP" , function(){
	...
	window.location = "index.php?url=convocatoriasCap&Cid="+Cid+"&documentoConvocatorias1="+documentoConvocatorias1;
	window.location = "index.php?url=convocatoriasCap&Cid="+Cid+"&documentoConvocatorias2="+documentoConvocatorias2;
	window.location = "index.php?url=convocatoriasCap&Cid="+Cid+"&documentoConvocatorias3="+documentoConvocatorias3;
	window.location = "index.php?url=convocatoriasCap&Cid="+Cid+"&documentoConvocatorias4="+documentoConvocatorias4;
	window.location = "index.php?url=convocatoriasCap&Cid="+Cid+"&documentoConvocatorias5="+documentoConvocatorias5;
	window.location = "index.php?url=convocatoriasCap&Cid="+Cid+"&documentoConvocatorias6="+documentoConvocatorias6;
	window.location = "index.php?url=convocatoriasCap&Cid="+Cid+"&documentoConvocatorias7="+documentoConvocatorias7;
