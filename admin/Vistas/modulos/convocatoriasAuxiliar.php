...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Gestor de Convocatorias Auxiliar
      </h1>
          ...
          <table class="table table-bordered table-hover table-striped TB">
            ...
            <!-- <tr>
              ...
              <?php 
                ...
                $verC = ConvocatoriasAuxiliarC::VerConvocatoriasAuxiliarC($item, $valor);
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <form method="post" role="form" enctype="multipart/form-data">
          ...
          //$crearS = new  SlideC();
            //$crearS->CrearSlideC();
          $crearC = new ConvocatoriasAuxiliarC();
          $crearC->CrearConvocatoriasAuxiliarC();
      ...
      <div class="modal-content">
        <form method="post" role="form" enctype="multipart/form-data">
          ...
          // $actualizarS = new SlideC();
           ...
           $actualizarC = new ConvocatoriasAuxiliarC();
          $actualizarC-> ActualizarConvocatoriasAuxiliarC();
 ...
 // $borrarS = new SlideC();
  ...
  $borrarC = new ConvocatoriasAuxiliarC();
  $borrarC->BorrarConvocatoriasAuxiliarC();
