...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Gestor de Convocatorias Directivos
      </h1>
          ...
          <table class="table table-bordered table-hover table-striped TB">
            ...
            <!-- <tr>
              ...
              <?php 
                ...
                $verC = ConvocatoriasDirectivosC::VerConvocatoriasDirectivosC($item, $valor);
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <form method="post" role="form" enctype="multipart/form-data">
          ...
          //$crearS = new  SlideC();
            //$crearS->CrearSlideC();
          $crearC = new ConvocatoriasDirectivosC();
          $crearC->CrearConvocatoriasDirectivosC();
 ...
 $borrarU->BorrarUsuariosC();
  ...
  <div class="modal fade" role="dialog" id="EditarCDI">
    <div class="modal-dialog">
      <div class="modal-content">
        <form method="post" role="form" enctype="multipart/form-data">
          ...
          // $actualizarS = new SlideC();
           ...
           $actualizarC = new ConvocatoriasDirectivosC();
          $actualizarC-> ActualizarConvocatoriasDirectivosC();
 ...
 // $borrarS = new SlideC();
  ...
  $borrarC = new ConvocatoriasDirectivosC();
  $borrarC->BorrarConvocatoriasDirectivosC();
