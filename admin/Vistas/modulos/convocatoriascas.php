...
<!-- Content Wrapper. Contains page content -->
          ...
          <table class="table table-bordered table-hover table-striped TB">
            ...
            <!-- <tr>
              ...
              <?php 
                ...
                $verC = ConvocatoriasCasC::VerConvocatoriasCasC($item, $valor);
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <form method="post" role="form" enctype="multipart/form-data">
          ...
          //$crearS = new  SlideC();
            //$crearS->CrearSlideC();
          $crearC = new ConvocatoriasCasC();
          $crearC->CrearConvocatoriasCasC();
      ...
      <div class="modal-content">
        <form method="post" role="form" enctype="multipart/form-data">
          ...
          // $actualizarS = new SlideC();
           ...
           $actualizarC = new ConvocatoriasCasC();
          $actualizarC-> ActualizarConvocatoriasCasC();
 ...
 // $borrarS = new SlideC();
  ...
  $borrarC = new ConvocatoriasCasC();
  $borrarC->BorrarConvocatoriasCasC();
