...
<!-- Content Wrapper. Contains page content -->
          ...
          <table class="table table-bordered table-hover table-striped TB">
            ...
            <!-- <tr>
              ...
              <?php 
                ...
                $verC = ConvocatoriasCapC::VerConvocatoriasCapC($item, $valor);
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <form method="post" role="form" enctype="multipart/form-data">
          ...
          //$crearS = new  SlideC();
            //$crearS->CrearSlideC();
          $crearC = new ConvocatoriasCapC();
          $crearC->CrearConvocatoriasCapC();
      ...
      <div class="modal-content">
        <form method="post" role="form" enctype="multipart/form-data">
          ...
          // $actualizarS = new SlideC();
           ...
           $actualizarC = new ConvocatoriasCapC();
          $actualizarC-> ActualizarConvocatoriasCapC();
 ...
 // $borrarS = new SlideC();
  ...
  $borrarC = new ConvocatoriasCapC();
  $borrarC->BorrarConvocatoriasCapC();
