...
require "../../controlador/convocatoriascasC.php";
require "../../modelo/convocatoriascasM.php";
 ?>
 ...
 <section class="main-gestion-inst">
        <div class="items-box">
            ...
            <div class="comunicados-content convocatoria">
                    <table  width="auto" class="table table-responsive" id="castt" >
                        ...
                        <tbody>
                            ...
                            $convocatorias = new ConvocatoriasCasC();
                            $convocatorias->MostrarConvocatoriasCasC();
