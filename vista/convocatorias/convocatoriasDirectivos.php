...
require "../../controlador/convocatoriasdirectivosC.php";
require "../../modelo/convocatoriasdirectivosM.php";
 ?>
 ...
 <section class="main-gestion-inst">
        <div class="items-box">
            ...
            <div class="comunicados-content convocatoria">
                    <table  width="auto" class="table table-responsive" id="directivott">
                        ...
                        <tbody>
                            ...
                            $convocatorias = new ConvocatoriasDirectivosC();
                            $convocatorias->MostrarConvocatoriasDirectivosC();
