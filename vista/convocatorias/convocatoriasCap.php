...
require "../../controlador/convocatoriascapC.php";
require "../../modelo/convocatoriascapM.php";
 ?>
 ...
 <section class="main-gestion-inst">
        <div class="items-box">
            ...
            <div class="comunicados-content convocatoria">
                    <table  width="auto" class="table table-responsive" id="captt">
                        ...
                        <tbody>
                            ...
                            $convocatorias = new ConvocatoriasCapC();
                            $convocatorias->MostrarConvocatoriasCapC();
