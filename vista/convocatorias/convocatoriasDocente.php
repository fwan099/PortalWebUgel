...
require "../../controlador/convocatoriasdocenteC.php";
require "../../modelo/convocatoriasdocenteM.php";
 ?>
 ...
 <section class="main-gestion-inst">
        <div class="items-box">
            ...
            <div class="comunicados-content convocatoria">
                    <table  width="auto" class="table table-responsive" id="docentett" >
                        ...
                        <tbody>
                            ...
                            $convocatorias = new ConvocatoriasDocenteC();
                            $convocatorias->MostrarConvocatoriasDocenteC();
