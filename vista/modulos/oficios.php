...
require "../layouts/header.php";
 ...
 require "../../controlador/oficiossC.php";
require "../../modelo/oficiossM.php";
 ?>
...
<style type="text/css">
 ...
 <section class="main-gestion-inst">
        <div class="items-box">
            <div class="title-box">
                <span>TODOS LOS LOS OFICIOS MULTIPLES</span>
                
            </div>
            <div class="comunicados-content">
                    <table  width="auto" class="table table-responsive" id="oftt" >
                        <thead>
                            <tr>
                                <th>N°</th>
                                <th>Titulo</th>
