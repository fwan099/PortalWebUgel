...
require "../../controlador/funciones_rhC.php";
require "../../controlador/jefearea_rhC.php";
require "../../controlador/jefesub_rhC.php";


require "../../modelo/funciones_rhM.php";
require "../../modelo/jefearea_rhM.php";
require "../../modelo/jefesub_rhM.php";
 ?>
...
<section class="main-gestion-inst">
        <div class="items-box">
            <div class="title-box">
                <span>AREA DE RECURSOS HUMANOS</span>
                ...
                <div class="item-boxes">
                    <a href="#" >
                        <div class="item-box-main especial">
                            ...
                            <span><button data-toggle="modal" data-target="#verJefeSubArea">PERSONAL DE APOYO</button></span>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle"><b>JEFE DEL AREA DE RECURSOS HUMANOS</b></h5>
   ...
   <!-- Modal -->
<div class="modal fade" id="verJefeSubArea" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle"><b>JEFE DE SUBAREA</b></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
