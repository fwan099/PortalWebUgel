...
require "../../controlador/funciones_giC.php";
require "../../controlador/jefearea_giC.php";
require "../../controlador/jefesubC.php";


require "../../modelo/funciones_giM.php";
require "../../modelo/jefearea_giM.php";
require "../../modelo/jefesubM.php";
 ?>
 ...
 <!-- Maquetado de la parte del contenido del modulo-->
    <section class="main-gestion-inst">
        <div class="items-box">
            <div class="title-box">
                <span>AREA DE GESTION INSTITUCIONAL</span>
            ...
            <div class="box-services box-inst">
               <div class="services inst-services">
                ...
                <div class="item-boxes">
                    <a href="#">
                        <div class="item-box-main">
                            <span><button data-toggle="modal" data-target="#subArea1">FINANZAS</button></span>
                ...
                <div class="item-boxes">
                    <a href="#">
                        <div class="item-box-main">
                            <span><button data-toggle="modal" data-target="#subArea2">PLANIFICACION</button></span>
                ...
                <div class="item-boxes">
                    <a href="#">
                        <div class="item-box-main">
                            <span><button data-toggle="modal" data-target="#subArea3">INFRAESTRUCUTURA</button></span>
                ...
                <div class="item-boxes">
                    <a href="#">
                        <div class="item-box-main">
                            <span><button data-toggle="modal" data-target="#subArea4">RACIONALIZACION</button></span>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle"><b>JEFE DEL AREA DE GESTION INSTITUCIONAL</b></h5>
...
<div class="modal fade" id="subArea1" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle"><b>JEFE DEL SUBAREA DE FINANZAS</b></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<div class="modal fade" id="subArea2" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle"><b>JEFE DEL SUBAREA DE PLANIFICACION</b></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<div class="modal fade" id="subArea3" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle"><b>JEFE DEL SUBAREA DE INFRAESTRUCURA</b></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<div class="modal fade" id="subArea4" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle"><b>JEFE DEL SUBAREA DE RACIONALIZACION</b></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
